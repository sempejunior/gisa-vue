                      ...
                      <v-row wrap>
                        <v-col xs12 md4>
                          <v-text-field
                            ...
                            class="purple-input"
                            label="User Name"
                            :value="$auth.user['http:user'].user_metadata.nome"
                          />
                        </v-col>
                      </v-row>
                      <v-row wrap>
                      ...
                      <v-row wrap>
                        <v-col xs12 md12>
                          <v-select
                            ...
                            :value="$auth.user['http:user'].user_metadata.role"
                          ></v-select>
                        </v-col>
						<v-col xs12 md12>
							<!-- CRIAR UM IF POR PERFIL -->
                          <v-select
                            :items="items"
                            label="Área de atuação"
                            :value="$auth.user['http:user'].user_metadata.areaAtuacao"
                          ></v-select>
                        </v-col>
                      </v-row>
                      <v-row wrap>
          ...
          <template v-slot:crdInner>
            ...
            <v-card-text class="text-center">
              ...
              <p class="text-body-1 font-weight-light">
                ...
                cool. i just told everyone in my family about it, everybody
                thinks that's very impressive and asked me to congratulate you.
                they want to speak to you in person, if possible, to give you
                their regards. they also said they will tell our distant
                relatives in christmas supper and in NYE they will ignite
                fireworks that spell your name. i also told about this enormous
                deed to closer relatives, they had the same reaction. they asked
                for your address so they can send congratulatory cards and
                messages. my friends didn't believe me when i told them i knew
                the author of this gigantic feat, really, they were dumbstruck,
                they said they will make your name echo through years and years
                to come. when my neighbour found out about what you did, he was
                completely dumbstruck too, he wanted to know who you are and he
                asked (if you have the time, of course) if you could stop by to
                receive gifts, congratulations and handshakes. with the
                spreading of the news, a powerful businessman of the area
                ...
                boom speakers, anything that can make your name stand out more
                and see which city can congratulate you the hardest for this
                magnificent feat.
              </p>
